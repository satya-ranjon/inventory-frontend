...
export function CustomerForm({ customer }: CustomerFormProps) {
  ...
  // Debug output
  console.log("Customer form received data:", customer);
  ...
  // Reset form values when customer data changes
  useEffect(() => {
    if (customer) {
      console.log("Resetting form with customer data:", customer);
      form.reset(customer);

      // Also update the state values
      setContactPersons(customer.contactPersons || []);
      setReportingTags(customer.reportingTags || []);
    }
  }, [customer, form]);
