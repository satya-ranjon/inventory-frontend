...
// This wraps the form in a more specific type
type FormData = CustomerFormValues;
...
export function CustomerForm({ customer }: CustomerFormProps) {
  ...
  // We need to cast the form type as any to avoid TypeScript errors with Zod integration
  // @ts-expect-error - Known issue with zodResolver and react-hook-form types
  const form = useForm({
  ...
  // @ts-expect-error - Form submit handler type incompatibility
  const onSubmit = (data) => {
