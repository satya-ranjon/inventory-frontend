...
interface SalesOrderFormProps {
  salesOrder?: SalesOrderFormValues & { subTotal?: number; total?: number };
...
export function SalesOrderForm({
  ...
  const onSubmit = async (data: SalesOrderFormValues) => {
    try {
      ...
      // These will be stored in the backend but aren't part of the formal schema
      const orderData = {
        ...data,
      ...
      if (salesOrder?._id) {
        updateSalesOrder({
          id: salesOrder._id,
          data: orderData as any, // Type casting to avoid conflicts
        });
        toast.success("Sales order updated successfully");
      } else {
        createSalesOrder(orderData as any); // Type casting to avoid conflicts
