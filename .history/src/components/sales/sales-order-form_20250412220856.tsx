...
interface ExtendedSalesOrderData extends SalesOrderFormValues {
  subTotal?: number;
  total?: number;
}
...
export function SalesOrderForm({
  ...
  const onSubmit = async (data: SalesOrderFormValues) => {
    try {
      ...
      // Add calculated values to be stored with order
      const extendedData: ExtendedSalesOrderData = {
        ...orderData,
        subTotal,
        total,
      };
