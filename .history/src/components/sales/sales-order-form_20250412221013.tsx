  ...
  const onSubmit = async (data: SalesOrderFormValues) => {
    try {
      ...
      if (salesOrder?._id) {
        updateSalesOrder({
          id: salesOrder._id,
          data: orderData as SalesOrderFormValues, // Safe cast back to expected type
        });
        toast.success("Sales order updated successfully");
      } else {
        createSalesOrder(orderData as SalesOrderFormValues); // Safe cast back to expected type
